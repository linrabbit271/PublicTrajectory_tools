...
class Stage5TransitDepartApp(QDialog):
    def __init__(self, parent, selected_files_db):
        ...
        # 初始化安全通讯器
        self.updater = TransitDepartUpdater()
    ...
    def setup_ui(self):
        ...
        self.tz_combo.setMaxVisibleItems(10)  # 强行限制高度为10项，完美适配滚轮
        ...
        self.tz_combo.setStyleSheet("""
            ...
            QComboBox:focus { border: 2px solid #fd7e14; }
        ...
        def create_input_row(label_text, mode):
            ...
            entry.setStyleSheet("""
                ...
                QLineEdit:focus { border: 2px solid #fd7e14; }
            """)
        ...
        self.progress_bar.setStyleSheet("""
            ...
            QProgressBar::chunk { background-color: #fd7e14; border-radius: 3px; }
        """)
    ...
    def _giant_table_worker(self, file_data, timezone, location, country, airport, flight):
        ...
        try:
            ...
            output_folder = os.path.join(source_dir, "-5-中转机场起飞-")
            os.makedirs(output_folder, exist_ok=True)

            output_filepath = os.path.join(output_folder, f"{bl_no} 中转起飞--{pkg_count}.xlsx")
            ...
            if HAS_XLSXWRITER:
                ...
                for row_num, pkg in enumerate(unique_pkgs, 1):
                    ...
                    worksheet.write_string(row_num, 3, "中转机场起飞")
                    worksheet.write_string(row_num, 4, "Departed from the Transit Airport")
    ...
    def _open_output_folder(self):
        try:
            ...
            target_dir = os.path.join(os.path.dirname(first_file["file_path"]), "-5-中转机场起飞-")
